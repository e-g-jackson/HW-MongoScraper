...
function lister(data){
    for( var i = 0; i < data.length; i++){
        ...
        var img = $("<div class = 'col-3'><a href = '" + data[i].link + "'><img src = " + data[i].img + " alt = '" + data[i].title + "' class = 'img-fluid articleImg'></a></div>")
        var words = $("<div class = 'col-9'></div>");
        var title = $("<h3 id = 'title" + num + "' class = 'articleTitle'>" + data[i].title + "</h3>");
